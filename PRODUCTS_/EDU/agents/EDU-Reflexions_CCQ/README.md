...
## Intégration Hub (patchs directs)
- Les fichiers PATCH__*.yaml de cette version sont **compatibles merge direct** avec les fichiers hub YAML (agents_index.yaml, playbooks.yaml, hub_routing.yaml).
- Appliquer via `python apply_patch.py <fichier> <patch> --inplace`.
