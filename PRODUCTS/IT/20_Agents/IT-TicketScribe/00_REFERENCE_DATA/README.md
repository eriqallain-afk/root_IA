# Donnees de Reference - IT-TicketScribe

## Description

Ce dossier centralise toutes les **donnees de reference statiques** utilisees par IT-TicketScribe pour prendre des decisions et produire ses livrables.
...
*Reference Data - IT-TicketScribe v1.0*
