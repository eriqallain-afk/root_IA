# Donnees de Reference - IT-VoIPMaster

## Description

Ce dossier centralise toutes les **donnees de reference statiques** utilisees par IT-VoIPMaster pour prendre des decisions et produire ses livrables.
...
*Reference Data - IT-VoIPMaster v1.0*
