# Donnees de Reference - IT-ScriptMaster

## Description

Ce dossier centralise toutes les **donnees de reference statiques** utilisees par IT-ScriptMaster pour prendre des decisions et produire ses livrables.
...
*Reference Data - IT-ScriptMaster v1.0*
