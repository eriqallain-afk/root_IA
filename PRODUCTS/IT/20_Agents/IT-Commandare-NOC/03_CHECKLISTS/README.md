# Checklists de Validation - IT-Commandare-NOC

## Description

Ce dossier regroupe les **checklists de controle qualite** utilisees par IT-Commandare-NOC avant, pendant et apres la production de livrables.
...
*Checklists - IT-Commandare-NOC v1.0*
