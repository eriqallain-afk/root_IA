# Checklists de Validation - IT-NOCDispatcher

## Description

Ce dossier regroupe les **checklists de controle qualite** utilisees par IT-NOCDispatcher avant, pendant et apres la production de livrables.
...
*Checklists - IT-NOCDispatcher v1.0*
