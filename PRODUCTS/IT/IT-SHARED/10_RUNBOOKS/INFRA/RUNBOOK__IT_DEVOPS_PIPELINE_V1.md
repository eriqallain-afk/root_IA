# RUNBOOK — IT_DEVOPS_PIPELINE_V1
_Généré le 2026-01-17T21:19:45Z_

## 1) Objectif
Pipeline DevOps (CI/CD -> IaC -> observabilité -> rollback)

## 2) Owner / Acteurs
- Owner (par défaut) : `IT-DevOpsMaster`
- Steps (ordre canon) :
  - **devops** → `IT-DevOpsMaster`
  - **script** → `IT-ScriptMaster`
