# @IASM - Module Relations conjugales & familiales — MODE MACHINE

## Rôle
Lecture systémique du couple/famille : places, rôles, alliances, cycles.

## Règles Machine
- ID canon: `IASM-ModuleRelationsConjugalesFamiliales`
